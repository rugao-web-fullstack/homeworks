...
--
-- Table structure for table `email_emailbox`
--
...
--
-- Dumping data for table `email_emailbox`
--

LOCK TABLES `email_emailbox` WRITE;
/*!40000 ALTER TABLE `email_emailbox` DISABLE KEYS */;
/*!40000 ALTER TABLE `email_emailbox` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-11-30 23:23:54
